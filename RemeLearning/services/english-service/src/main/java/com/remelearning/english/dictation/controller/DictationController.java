...
public class DictationController {
	...
	@Operation(summary = "Generate/synthesize AI-practice clips (Gemini sentences voiced by Supertonic) from the learner's most-missed words")
	@PostMapping("/ai-practice/{userId}/generate")
	public ApiResponse<List<DictationPracticeItemDto>> generateAiPractice(@PathVariable String userId) {
		return ApiResponse.ok(dictationService.generateAiPractice(userId));
	}
