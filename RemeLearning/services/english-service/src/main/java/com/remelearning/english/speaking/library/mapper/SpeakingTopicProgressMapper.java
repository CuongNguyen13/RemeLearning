...
@Mapper
public interface SpeakingTopicProgressMapper {

	SpeakingTopicProgress findByUserIdAndTopicId(@Param("userId") String userId, @Param("topicId") Long topicId);

	List<SpeakingTopicProgress> findByUserId(@Param("userId") String userId);
