 ...
 * {@code recommendations.exercises}). Registered per-column in {@code RecommendationMapper.xml}
 * rather than globally, since it's the only column in this service that needs it.
 */
