 ...
 * affected beans explicitly here until the environment/dependency versions are reconciled. Copied
 * verbatim from english-service's config.Boot4CompatConfig - delete once proper Boot 4 releases of
 * these starters exist.
 */
@Configuration
